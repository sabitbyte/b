...
*/
kangaroo = createSprite(100,100,30,30)
kangaroo.addImage("kangaroo",kangaroo_running)
kangaroo_collided = createSprite(100,100,30,30)
kangaroo_collided.addImage("kangaroo",kangaroo_running)
kangaroo.setCollider(300,300)
//Create a sprite for Invsible ground and place it at the bottom side of the screen.
  invisiblejungle = createSprite(10,400,800,10)
